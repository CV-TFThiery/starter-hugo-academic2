...
email: ""
---
My research interests include <p>{{style="color: red"} **approximation algorithms and combinatorial optimization**}<\p>. More specifically, I am particularly interested in the design of efficient algorithms with provable guarantees for problems motivated by theory, data analysis, and machine learning applications. \
\
